...
/*	private double[] temp = new double[9];
    ...
    public ENG_Matrix3(double scalar) {
        if (scalar != 0.0f) {
            set(scalar);
        }
    }
    ...
    public ENG_Matrix3(double[] mat, boolean copy) {
        if (copy) {
    ...
    public ENG_Matrix3(double m0, double m1, double m2, double m3,
    ...
    private static boolean invert(double[] s, double[] d, double tolerance) {
        d[0] = s[4] * s[8] - s[5] * s[7];
        d[1] = s[2] * s[7] - s[1] * s[8];
        d[2] = s[1] * s[5] - s[2] * s[4];
        d[3] = s[5] * s[6] - s[3] * s[8];
        ...
        double fDet = s[0] * d[0] + s[1] * d[3] + s[2] * d[6];
    ...
    public double determinant() {
        double x = m[4] * m[8] - m[5] * m[7];
        double y = m[5] * m[6] - m[3] * m[8];
        double z = m[3] * m[7] - m[4] * m[6];
        return (m[0] * x + m[1] * y + m[2] * z);
    }

    public static boolean invert(ENG_Matrix3 src, ENG_Matrix3 dest, double tolerance) {
        double[] s = src.get();
        double[] d = dest.get();
    ...
    private static void addm3m3m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[3] = m1[3] + m2[3];
    ...
    private static void addm4m3m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[3] = m1[4] + m2[3];
    ...
    private static void addm3m4m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[3] = m1[3] + m2[4];
    ...
    private static void addm4m4m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[3] = m1[4] + m2[4];
    ...
    private static void subm3m3m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[3] = m1[3] - m2[3];
    ...
    private static void subm4m3m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[3] = m1[4] - m2[3];
    ...
    private static void subm3m4m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[3] = m1[3] - m2[4];
    ...
    private static void subm4m4m3(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[3] = m1[4] - m2[4];
    ...
    public ENG_Matrix3 mulRet(double scalar) {
    ...
    public ENG_Matrix3 divRet(double scalar) {
        ENG_Matrix3 mat = new ENG_Matrix3();
        mat.set(m);
        mat.div(scalar);
        return mat;
    ...
    private static void setMat4ToMat3(double[] mat3, double[] mat4) {
        mat3[0] = mat4[0];
        mat3[1] = mat4[1];
        mat3[2] = mat4[2];
        mat3[3] = mat4[4];
...
//    }
    ...
    public void fromAxisAngle(ENG_Vector4D rkAxis, double fRadians) {
        // TODO Auto-generated method stub
        double fCos = ENG_Math.cos(fRadians);
        double fSin = ENG_Math.sin(fRadians);
