...
public class ENG_Matrix4 {
    ...
    /*private double[] temp = new double[16];
	private double[] temp2 = new double[16];
    ...
    public ENG_Matrix4(double scalar) {
        if (scalar != 0.0f) {
            set(scalar);
        }
    }
    ...
    public ENG_Matrix4(double[] mat) {
        System.arraycopy(mat, 0, m, 0, m.length);
    }

    public ENG_Matrix4(double m0, double m1, double m2, double m3,
    ...
    private static void setMat3ToMat4(double[] mat4, double[] mat3) {
        mat4[0] = mat3[0];
        mat4[1] = mat3[1];
        mat4[2] = mat3[2];
        mat4[4] = mat3[3];
    ...
    public boolean hasScale() {
        double t = m[0] * m[0] + m[4] * m[4] + m[8] * m[8];
        if (ENG_Double.compareTo(t, 1.0f, (double) 1e-04) == ENG_Utility.COMPARE_EQUAL_TO) {
            return true;
        }
        ...
        return ENG_Double.compareTo(t, 1.0f, (double) 1e-04) == ENG_Utility.COMPARE_EQUAL_TO;
    }
    ...
    private static void setMat4toMat43x3(double[] m0, double[] m1) {
        m0[0] = m1[0];
        m0[1] = m1[1];
        m0[2] = m1[2];
        m0[4] = m1[4];
    ...
    public void set(double m0, double m1, double m2, double m3,
                    double m4, double m5, double m6, double m7,
                    double m8, double m9, double m10, double m11,
                    double m12, double m13, double m14, double m15) {
        m[0] = m0;
    ...
    public static double minor(ENG_Matrix4 m, int r0, int r1, int r2,
...
/*	public ENG_Matrix4 invertAffineRet() {
    ...
    public static void invertAffine(ENG_Matrix4 src, ENG_Matrix4 ret) {
        if (src.isAffine()) {
            ...
            double m03 = m[3], m13 = m[7], m23 = m[11];
    ...
    private static void addm4m4m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[3] = m1[3] + m2[3];
    ...
    private static void subm4m4m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[3] = m1[3] - m2[3];
    ...
    private static void addm3m3m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[4] = m1[3] + m2[3];
    ...
    private static void addm4m3m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[4] = m1[4] + m2[3];
    ...
    private static void addm3m4m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] + m2[0];
        ret[1] = m1[1] + m2[1];
        ret[2] = m1[2] + m2[2];
        ret[4] = m1[3] + m2[4];
    ...
    private static void subm3m3m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[4] = m1[3] - m2[3];
    ...
    private static void subm4m3m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[4] = m1[4] - m2[3];
    ...
    private static void subm3m4m4(double[] m1, double[] m2, double[] ret) {
        ret[0] = m1[0] - m2[0];
        ret[1] = m1[1] - m2[1];
        ret[2] = m1[2] - m2[2];
        ret[4] = m1[3] - m2[4];
    ...
    private static void concatenate(double[] m1, double[] m2, double[] ret) {
    ...
    private static void concatenateAffine(double[] m1, double[] m2, double[] ret) {
    ...
    public ENG_Matrix4 mulRet(double scalar) {
    ...
    private static void mul(double[] m, double scalar) {
        m[0] *= scalar;
        m[1] *= scalar;
        m[2] *= scalar;
        m[3] *= scalar;
    ...
    public ENG_Matrix4 divRet(double scalar) {
        ENG_Matrix4 mat = new ENG_Matrix4();
        mat.set(m);
        mat.div(scalar);
        return mat;
    ...
    public void transform(double[] vectors) {
        if (vectors == null) {
            throw new NullPointerException();
        }
    ...
    private void transform(double[] m, ENG_Vector3D vec, ENG_Vector3D ret) {
        double fInvW = 1.0f / (m[3] * vec.x + m[7] * vec.y + m[11] * vec.z);
    ...
    private void transform(double[] m, ENG_Vector4D vec, ENG_Vector4D ret) {
    ...
    public void makeTrans(double x, double y, double z) {
        m[0] = 1.0f;
        m[1] = 0.0f;
        m[2] = 0.0f;
        m[3] = x;
    ...
    private static void makeTrans(double[] m, ENG_Vector3D vec) {
        //	double[] m = mat.get();
        m[0] = 1.0f;
        m[1] = 0.0f;
        m[2] = 0.0f;
    ...
    private static void makeTrans(double[] m, ENG_Vector4D vec) {
        //	double[] m = mat.get();
        m[0] = 1.0f;
        m[1] = 0.0f;
        m[2] = 0.0f;
    ...
    public void postTranslate(double x, double y, double z) {
        ENG_Vector3D vec3 = new ENG_Vector3D();
        double[] temp = new double[16];
    ...
    private static void makeScale(double[] m, ENG_Vector3D vec) {
        m[0] = vec.x;
        m[1] = 0.0f;
        m[2] = 0.0f;
        m[3] = 0.0f;
    ...
    private static void makeScale(double[] m, ENG_Vector4D vec) {
        m[0] = vec.x;
        m[1] = 0.0f;
        m[2] = 0.0f;
        m[3] = 0.0f;
    ...
    public void postScale(double x, double y, double z) {
        ENG_Vector3D vec3 = new ENG_Vector3D();
        double[] temp = new double[16];
        double[] temp2 = new double[16];
        vec3.set(x, y, z);
     ...
     * 	xx(1-c)+c    xy(1-c)-zs   xz(1-c)+ys   0
        ...
        xz(1-c)-ys   yz(1-c)+xs   zz(1-c)+c    0
             0            0            0       	1
     */
    private void makeRotate(double[] m, double angle, double x, double y, double z) {
        double c = ENG_Math.cos(angle);
        double s = ENG_Math.sin(angle);
        double invc = 1.0f - c;
        ENG_Vector3D vec3 = new ENG_Vector3D();
        vec3.set(x, y, z);
    ...
    public void makeRotate(double angle, double x, double y, double z, ENG_Matrix4 mat) {
        makeRotate(mat.get(), angle, x, y, z);
    }

    public ENG_Matrix4 makeRotate(double angle, double x, double y, double z) {
        ENG_Matrix4 mat = new ENG_Matrix4();
        makeRotate(mat.get(), angle, x, y, z);
        return mat;
    }
    ...
    public void postRotate(double angle, double x, double y, double z) {
        double[] temp = new double[16];
        double[] temp2 = new double[16];
    ...
    private static void setIdentityFull(double[] mat) {
        mat[0] = 1.0f;
        mat[1] = 0.0f;
        mat[2] = 0.0f;
        mat[3] = 0.0f;
    ...
    private static void matrix_set_translation(double[] mat, double x, double y, double z) {
        mat[3] = x;
        mat[7] = y;
        mat[11] = z;
    }

    private static void matrix_set_basis_vectors(double[] mat, ENG_Vector3D xAxis, ENG_Vector3D yAxis, ENG_Vector3D zAxis) {
        mat[0] = xAxis.x;
        mat[1] = yAxis.x;
        mat[2] = zAxis.x;
    ...
    private static void matrix_set_transposed_basis_vectors(double[] mat, ENG_Vector3D xAxis, ENG_Vector3D yAxis, ENG_Vector3D zAxis) {
        mat[0] = xAxis.x;
        mat[1] = xAxis.y;
        mat[2] = xAxis.z;
    ...
    private static void matrix_set_basis_vectors(double[] mat, ENG_Vector4D xAxis, ENG_Vector4D yAxis, ENG_Vector4D zAxis) {
        mat[0] = xAxis.x;
        mat[1] = yAxis.x;
        mat[2] = zAxis.x;
    ...
    private static void matrix_set_transposed_basis_vectors(double[] mat, ENG_Vector4D xAxis, ENG_Vector4D yAxis, ENG_Vector4D zAxis) {
        mat[0] = xAxis.x;
        mat[1] = xAxis.y;
        mat[2] = xAxis.z;
