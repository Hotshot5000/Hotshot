...
public class LevelWaypoint {
    ...
    public int getMaxWaypointAttachmentCount() {
        return maxWaypointAttachmentCount;
    }
    ...
    public ENG_Vector4D getEntranceOrExitDirection() {
        return entranceOrExitDirection;
    }

    public float getEntranceOrExitAngle() {
        return entranceOrExitAngle;
    }

    public float getEntranceOrExitMinDistance() {
        return entranceOrExitMinDistance;
    }

    public boolean isEntranceOrExitActive() {
        return entranceOrExitActive;
    }
