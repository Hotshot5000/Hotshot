...
public class ShipData extends EntityData {
    ...
    public enum ShipType {
        ...
        public static ShipType getValueOf(String s) {
            if (FIGHTER.toString().equalsIgnoreCase(s) || (FIGHTER.toString() + "_ship").equalsIgnoreCase(s)) {
                return FIGHTER;
            } else if (CARGO.toString().equalsIgnoreCase(s) || (CARGO.toString() + "_ship").equalsIgnoreCase(s)) {
                return CARGO;
            } else if (RELOADER.toString().equalsIgnoreCase(s) || (RELOADER.toString() + "_ship").equalsIgnoreCase(s)) {
                return RELOADER;
            } else {
...
//                new TreeMap<>();
    ...
    private static TreeMap<String, ShipData> filenameShipMap =
            new TreeMap<>();
    ...
    public static ArrayList<ShipData> getShipData(int team, int type) {
        ...
        for (ShipData data : filenameShipMap.values()) {
    ...
    private static boolean shipMappingsCreated;
...
//        }
        shipMappingsCreated = true;
        MapWithFilenameAndName map = new MapWithFilenameAndName();

        ArrayList<ShipData> shipDataList = new ShipDataCompiler().compile("ship_data_list.txt", "", false);
