 ...
 */
public class AfterburnerButtonListener extends ENG_ButtonListenerWithState {

    private final ENG_ButtonOverlayElement afterburnerOverlay;

    public AfterburnerButtonListener(ENG_ButtonOverlayElement afterburnerOverlay) {
        this.afterburnerOverlay = afterburnerOverlay;
    }
    ...
    public void onClick(float x, float y, ENG_InputConvertor.TouchEventType type) {
        ...
        afterburnerOverlay.setPressed(type == ENG_InputConvertor.TouchEventType.DOWN || type == ENG_InputConvertor.TouchEventType.DOWNED
