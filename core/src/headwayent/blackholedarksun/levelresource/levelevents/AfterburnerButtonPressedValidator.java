...
public class AfterburnerButtonPressedValidator extends ButtonPressedValidator {

    public static class AfterburnerButtonPressedValidatorFactory extends LevelEventValidatorFactory {

        public static final String TYPE = "AfterburnerButtonPressedValidator";

        @Override
        public LevelEventValidator createLevelEventValidator(ArrayList<String> paramList) {
            return new AfterburnerButtonPressedValidator();
        }
    }
    ...
    public boolean checkSticky(LevelEvent levelEvent) {
        if (super.checkSticky(levelEvent)) {
            ...
            return shipProperties.isAfterburnerActive();
        }
        return false;
    }
}
