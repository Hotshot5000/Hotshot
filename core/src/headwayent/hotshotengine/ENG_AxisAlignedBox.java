...
//        ENG_Vector4D temp3 = new ENG_Vector4D(true);
    ...
    public boolean contains(ENG_Vector4D v) {
        return !isNull() && (isInfinite() || (min.compareLessThanOrEqual(v) && max.compareGreaterThanOrEqual(v)));
    }

    public boolean contains(ENG_AxisAlignedBox a) {
        return a.isNull() || isInfinite() || !(isNull() || a.isInfinite()) && (min.compareLessThanOrEqual(a.min) && a.max.compareLessThanOrEqual(max));
