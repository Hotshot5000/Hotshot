...
import headwayent.hotshotengine.android.util.Property;
import headwayent.hotshotengine.android.util.FloatProperty;
import headwayent.hotshotengine.android.util.IntProperty;
...
public class PropertyValuesHolder implements Cloneable {
    ...
    private static final Class[] FLOAT_VARIANTS = {float.class, Float.class, double.class, int.class,
            Double.class, Integer.class};
    private static final Class[] INTEGER_VARIANTS = {int.class, Integer.class, float.class, double.class,
            Float.class, Double.class};
    private static final Class[] DOUBLE_VARIANTS = {double.class, Double.class, float.class, int.class,
...
//    }
     ...
     */
    private static class PointFToFloatArray extends TypeConverter<headwayent.hotshotengine.android.graphics.PointF, float[]> {
        private final float[] mCoordinates = new float[2];

        public PointFToFloatArray() {
            super(headwayent.hotshotengine.android.graphics.PointF.class, float[].class);
        }

        @Override
        public float[] convert(headwayent.hotshotengine.android.graphics.PointF value) {
     ...
     */
    private static class PointFToIntArray extends TypeConverter<headwayent.hotshotengine.android.graphics.PointF, int[]> {
        private final int[] mCoordinates = new int[2];

        public PointFToIntArray() {
            super(headwayent.hotshotengine.android.graphics.PointF.class, int[].class);
        }

        @Override
        public int[] convert(headwayent.hotshotengine.android.graphics.PointF value) {
