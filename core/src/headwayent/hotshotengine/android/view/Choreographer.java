...
package headwayent.hotshotengine.android.view;
 ...
 * display frame rendering, use {@link headwayent.hotshotengine.android.animation.ValueAnimator#start}.</li>
...
//        mDisplayEventReceiver = null;//USE_VSYNC ? new FrameDisplayEventReceiver(looper) : null;
    ...
    private static float getRefreshRate() {
        return Gdx.graphics.getDisplayMode().refreshRate;//getDesktopDisplayMode().refreshRate;
    ...
    private void scheduleFrameLocked(long now) {
        if (!mFrameScheduled) {
            ...
            if (USE_VSYNC) {
                ...
                final long nextFrameTime = now + sFrameDelay;
//                        Math.max(
