...
public class ENG_Ray {
    ...
    public void intersects(ENG_Plane p, ENG_Boolean b, ENG_Float dist) {
        ENG_Math.intersects(p, this, b, dist);
    }

    public void intersects(ENG_Sphere s, ENG_Boolean b, ENG_Float dist) {
        ENG_Math.intersects(this, s, b, dist, true, temp0);
    }

    public void intersects(ENG_AxisAlignedBox a, ENG_Boolean b, ENG_Float dist) {
